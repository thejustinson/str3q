      ...
      >
        <div className="max-w-6xl mx-auto flex justify-between items-center w-full">
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.96 }}
            className="flex items-center justify-center px-6 py-3 rounded-xl font-semibold bg-[var(--flame-orange)] text-white shadow-[0_4px_20px_var(--color-flame-glow),inset_0_2px_0_rgba(255,255,255,0.2)] hover:shadow-[0_8px_30px_var(--color-flame-glow),inset_0_2px_0_rgba(255,255,255,0.2)] hover:brightness-110 transition-all duration-[0.4s] cursor-pointer"
          >
            Get started
          </motion.button>
        </div>
      ...
      <section className="w-full pt-[180px] pb-[100px] px-6 text-center bg-[radial-gradient(circle_at_50%_30%,rgba(255,94,26,0.1)_0%,transparent_60%)]">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            <button
              onClick={handleGoogleSignIn}
              className="flex items-center justify-center px-6 py-3 rounded-xl font-semibold text-[var(--flame-orange)] transition-all duration-[0.4s] text-lg hover:brightness-110 cursor-pointer"
            >
            ...
            <motion.button 
              ...
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
              className="flex items-center justify-center px-6 py-3 rounded-xl font-semibold bg-[var(--smoke-mid)] text-[var(--ghost-white)] border border-white/10 hover:bg-[var(--smoke-light)] transition-all duration-[0.4s] text-lg gap-2 cursor-pointer"
            >
      ...
      <section className="w-full py-[50px] px-6 mb-[50px]">
        ...
        >
          ...
          <motion.button 
            ...
            whileHover={{ scale: 1.04 }}
            whileTap={{ scale: 0.96 }}
            className="relative z-10 flex mx-auto items-center justify-center px-8 py-4 rounded-xl font-semibold bg-[var(--flame-orange)] text-white shadow-[0_4px_20px_var(--color-flame-glow),inset_0_2px_0_rgba(255,255,255,0.2)] hover:shadow-[0_8px_30px_var(--color-flame-glow),inset_0_2px_0_rgba(255,255,255,0.2)] hover:brightness-110 transition-all duration-[0.4s] text-xl gap-3 cursor-pointer"
          >
